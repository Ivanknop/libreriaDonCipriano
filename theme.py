...
def theme():
    ...
    '''
    sg.LOOK_AND_FEEL_TABLE['juego'] = {'BACKGROUND': '#222E50', #f9e4b7', #'#4f280a'
                                            'TEXT': '#FFFFFF',#FFF66E',
                                            'INPUT': '#c7e78b',
                                            'TEXT_INPUT': '#000000',
                                            'SCROLL': '#c7e78b',
                                            'BUTTON': ('#FFFFFF','#007991'), #('#EFB810','#F0001F'),
                                            'PROGRESS': ('#01826B', '#D0D0D0'),
                                            'BORDER': 1, 'SLIDER_DEPTH': 0, 'PROGRESS_DEPTH': 0,
                                            }
    sg.theme('juego')
def popUp(mensaje = 'Este es un mensaje estandar', botones = ['Entendido']):
...
if __name__ == '__main__':
   event =  aviso('Hola mundo' , ['Salir', 'OK', 'Jugar'])
   print(event)